...
def fibonacci_list_last_two_numbers(n):
     ...
     if n==1 or n==2:
          ...
          for i in range(3,n+1):
               last_two_numbers_in_series.insert(3,last_two_numbers_in_series[0]+last_two_numbers_in_series[1]) #insert the fin element at last of the list
               last_two_numbers_in_series.pop(0) #pop out the first element in the list of the series which will be unused
     return last_two_numbers_in_series
